...
/* harmony import */ var _lib_sendMyhonda__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lib/sendMyhonda */ "./src/assets/js/lib/sendMyhonda.js");
...
__webpack_require__(/*! ./lib/preload */ "./src/assets/js/lib/preload.js");

__webpack_require__(/*! ./lib/cycle */ "./src/assets/js/lib/cycle.js");

jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').jpreLoader({
    loaderVPos: '0%',
...
(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('*[data-toggle-menu], .main-menu-off > li > a').on('click', function (e) {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.menu-offcanvas, .close-menu').toggleClass('active');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.about-slide').cycle();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('*[data-bgimage]').each(function () {
    var dt = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('bgimage');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).css('backgroundImage', 'url(' + dt + ')').addClass('bgcover');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cycle-slideshow').on('cycle-after', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cycle-slide-active .slide-image, .cycle-slide-active .slide-text').addClass('show');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cycle-slideshow').on('cycle-initialized', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cycle-slide-active .slide-image, .cycle-slide-active .slide-text').addClass('show');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cycle-slideshow').on('cycle-before', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.cycle-slide-active .slide-image, .cycle-slide-active .slide-text').removeClass('show');
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('scroll', function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).scrollTop() > 160) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.scroll-menu, .back-top').addClass('show');
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.scroll-menu, .back-top').removeClass('show');
    }
  }); // formulario myhonda

  Object(_lib_sendMyhonda__WEBPACK_IMPORTED_MODULE_3__["getProductName"])();
})();
...
(function ($) {
  ...
  var createContainer = function createContainer() {
    ...
    jLoader = $('<div></div>').attr('id', 'jpreLoader').appendTo(jOverlay).wrapAll('<div class="preloadContent"></div>');
    ...
    if (jpreOptions.showPercentage) {
      jPer = $('<div></div>').attr('id', 'jprePercentage').appendTo(jLoader).html('Loading...');
    }
  ...
  var getImages = function getImages(element) {
  ...
  var completeLoading = function completeLoading() {
    ...
    if (current >= items.length) {
      ...
      $(jBar).stop().animate({
        ...
        //autoclose on
        if (jpreOptions.autoClose) loadComplete();else $(jButton).fadeIn(1000);
      });
    }
...
/***/ "./src/assets/js/lib/sendMyhonda.js":
/*!******************************************!*\
  !*** ./src/assets/js/lib/sendMyhonda.js ***!
  \******************************************/
/*! exports provided: sendForm, getProductName */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function sendForm() {
  ...
  var formHonda = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#myhonda');
  formHonda.on('submit', function (event) {
    event.preventDefault();
    var data = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).serializeArray();
    console.log(data); // fetch('https://webto.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8', init)
    //      .then(res => {
    //          console.log(res);
    //      })
    //      .catch(error => {
...
module.exports = __webpack_require__(/*! D:\honda-cavalcanti\src\assets\js\app.js */"./src/assets/js/app.js");
